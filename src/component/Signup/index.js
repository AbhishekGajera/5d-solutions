              ...
              <div className="mb-3 p-2 col-lg-6 submit-form-main">
                ...
                <div className="input-group-prepend d-flex">
                  <span className="input-group-text">
                    ...
                    >
                      <path
                        d="M2.08751 0.6875H17.9125C18.8418 0.6875 19.6 1.44485 19.6 2.375V13.625C19.6 14.552 18.8452 15.3125 17.9125 15.3125H2.08751C1.16051 15.3125 0.400007 14.5577 0.400007 13.625V2.375C0.400007 1.448 1.15481 0.6875 2.08751 0.6875ZM2.32053 1.8125L9.96423 9.45624L17.674 1.8125H2.32053ZM18.475 13.3921V2.60259L13.057 7.97409L18.475 13.3921ZM17.6795 14.1875L12.2581 8.76612L10.3585 10.6495C10.1386 10.8675 9.78374 10.8668 9.56474 10.6477L7.71251 8.79549L2.3205 14.1875H17.6795ZM1.52501 13.392L6.91702 8L1.52501 2.60795V13.392Z"
                        fill="#6D6D6D"
                      />
                    </svg>
                  </span>
              ...
              <div className="mb-3 p-2 col-lg-6 submit-form-main">
                ...
                <div className="input-group-prepend d-flex">
                  <span className="input-group-text">
                    ...
                    >
                      <path
                        d="M11.996 18.0157C12.3843 18.0157 12.6991 17.7008 12.6991 17.3126V14.4C12.6991 14.0116 12.3843 13.6968 11.996 13.6968C11.6078 13.6968 11.2928 14.0116 11.2928 14.4V17.3126C11.2928 17.7008 11.6078 18.0157 11.996 18.0157Z"
                        fill="#6D6D6D"
                      />
                      <path
                        d="M20.0544 7.7124H16.7267V4.28723C16.7267 1.92316 14.6045 0 11.996 0C9.38763 0 7.26544 1.92316 7.26544 4.28723V7.7124H3.9375C3.54913 7.7124 3.23438 8.02734 3.23438 8.41553V17.4077C3.23438 21.0427 6.19171 24 9.82672 24H14.1654C17.8004 24 20.7578 21.0427 20.7578 17.4077V8.41553C20.7576 8.02734 20.4428 7.7124 20.0544 7.7124ZM8.67169 4.28723C8.67169 2.69861 10.1629 1.40625 11.996 1.40625C13.829 1.40625 15.3204 2.69861 15.3204 4.28723V7.7124H8.67169V4.28723ZM19.3513 17.4077C19.3513 20.2672 17.025 22.5938 14.1652 22.5938H9.82672C6.96716 22.5938 4.64062 20.2672 4.64062 17.4077V9.11865H19.3513V17.4077Z"
                        fill="#6D6D6D"
                      />
                    </svg>
                  </span>
